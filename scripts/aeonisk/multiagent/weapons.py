...
WEAPON_LIBRARY: Dict[str, Weapon] = {
    ...
    "tranq_gun": Weapon(
        ...
        attack=0,
        defence=0,
        damage=4,  # +2 guns boost (was 2), relies on sedative
        damage_type="stun",
        reach=0,
        load=1,
        is_ranged=True,
    ...
    "hollowed_repeater": Weapon(
        ...
        attack=0,
        defence=0,
        damage=6,  # +2 guns boost (was 4), scales with void score (not implemented yet)
        damage_type="wound",
        reach=0,
        load=1,
        is_ranged=True,
    ...
    "breach_hammer": Weapon(
        ...
        attack=1,
        defence=0,
        damage=10,  # +3 melee boost (was 7), 2-handed weapon
        damage_type="wound",
        reach=1,
        load=5,  # Heavy weapon
    ...
    "oathpiercer_carbine": Weapon(
        ...
        attack=0,
        defence=0,
        damage=6,  # +2 guns boost (was 4), +DMG vs ex-Bonds
        damage_type="wound",
        reach=0,
        load=3,
        is_ranged=True,
    ...
    "drip_veil_projector": Weapon(
        ...
        attack=-1,  # Not designed for combat
        defence=0,
        damage=4,  # +2 guns boost (was 2), non-lethal
        damage_type="stun",
        reach=0,
        load=2,
        is_ranged=True,
    ...
    "compact_emp_pistol": Weapon(
        ...
        attack=0,
        defence=0,
        damage=5,  # +2 guns boost (was 3), relies on EMP effect
        damage_type="stun",
        reach=0,
        load=1,
        is_ranged=True,
