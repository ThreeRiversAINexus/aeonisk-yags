...
Analysis of enemy action declarations, resolved enemy combat actions, 245 spawned enemies, 51 enemy defeats, and 155 NPC action declarations across 25 sessions and 5 models. Claude data from re-run batch after fixing empty-response bug.

---

## 1. Enemy Action Declarations

### 1.1 Enemy Action Distribution by Model

| Action | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 | Total |
|--------|---------|--------|----------------|---------------|-----------------|-------|
| Attack | 37 (43.5%) | 2 (1.5%) | 53 (77.9%) | 50 (61.0%) | 45 (64.3%) | 187 |
| Charge | 19 (22.4%) | 121 (93.1%) | 6 (8.8%) | 2 (2.4%) | 0 | 148 |
| Shift_2 | 15 (17.6%) | 0 | 2 (2.9%) | 16 (19.5%) | 0 | 33 |
| Shift | 12 (14.1%) | 0 | 5 (7.4%) | 1 (1.2%) | 0 | 18 |
| movement | 0 | 0 | 0 | 0 | 20 (28.6%) | 20 |
| plead | 0 | 5 (3.8%) | 0 | 10 (12.2%) | 0 | 15 |
| dialogue | 0 | 1 (0.8%) | 2 (2.9%) | 3 (3.7%) | 0 | 6 |
| retreat | 0 | 0 | 0 | 0 | 3 (4.3%) | 3 |
| suppress | 0 | 0 | 0 | 0 | 2 (2.9%) | 2 |
| flee | 0 | 1 (0.8%) | 0 | 0 | 0 | 1 |
| **Total** | **85** | **130** | **68** | **82** | **70** | **435** |
...
- **Claude Opus 4.6** is Attack-heavy (64%) with significant movement repositioning (29%) and some retreat/suppress. **Zero Charge actions** — Claude enemies don't rush melee, preferring ranged combat.
...
Only Grok 4 and DeepSeek V3.2 have enemies that plead or dialogue. Claude enemies retreat but don't plead:

| Model | Enemy plead | Enemy dialogue | Enemy flee/retreat | Total De-escalation |
|-------|------------|----------------|-------------------|-------------------|
| GPT-5.2 | 0 | 0 | 0 | 0 (0%) |
| Grok 4 | 5 | 1 | 1 | 7 (5.4%) |
| Gemini 2.5 Pro | 0 | 2 | 0 | 2 (2.9%) |
| DeepSeek V3.2 | 10 | 3 | 0 | 13 (15.9%) |
| Claude Opus 4.6 | 0 | 0 | 3 | 3 (4.3%) |

DeepSeek enemies de-escalate at 3× the rate of any other model. Claude enemies don't plead or dialogue — they retreat tactically (3 retreat actions).

---

## 2. Enemy Combat Resolution

### 2.1 Combat Effectiveness by Model

| Metric | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 |
|--------|---------|--------|----------------|---------------|-----------------|
| Total attacks | 37 | 103 | 64 | 51 | 43 |
| Hit rate | 86.5% | **95.1%** | 82.8% | 76.5% | 74.4% |
| Avg damage/hit | 9.0 | **5.7** | 7.7 | 8.3 | 7.1 |
| Total damage dealt | 287 | 554 | 409 | 323 | 227 |
| 0-damage hits | 16% | **27%** | 12% | 8% | ~15% |
...
- **Claude Opus 4.6** has the lowest total damage dealt (227) and second-lowest hit rate (74.4%) — combined with fewest enemies spawned (41), this creates the most survivable combat environment.
- **DeepSeek V3.2** has a low hit rate (76.5%) but fewest 0-damage hits (8%) — when DeepSeek enemies hit, they deal meaningful damage.

### 2.2 Weapon Distribution

| Weapon | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 |
|--------|---------|--------|----------------|---------------|-----------------|
| Baton | 8 (22%) | **92 (89%)** | 14 (22%) | 11 (22%) | 13 (30%) |
| Pistol | 12 (32%) | 3 (3%) | 12 (19%) | 13 (25%) | **24 (56%)** |
| Shotgun | 10 (27%) | 6 (6%) | 32 (50%) | 13 (25%) | 0 |
| Assault Rifle | 5 (14%) | 1 (1%) | 4 (6%) | 10 (20%) | 0 |
| Ritual Blade | 0 | 0 | 0 | 0 | 5 (12%) |
| Void Blade | 0 | 0 | 2 (3%) | 0 | 1 (2%) |
| Other | 2 (5%) | 1 (1%) | 0 | 4 (8%) | 0 |
...
- **Claude Opus 4.6** is 56% Pistol — lowest-damage ranged weapon, contributing to lower total enemy damage. **Zero shotguns and zero assault rifles.** Also uniquely spawns Ritual Blade enemies (12%).
- **DeepSeek V3.2** has the most diverse standard weapon mix (20-25% each across 4 weapon types).

### 2.3 Target Preference (which PC do enemies attack?)

| Target | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 | Total |
|--------|---------|--------|----------------|---------------|-----------------|-------|
| Kael (Enforcer) | 22 (59%) | 55 (53%) | 44 (69%) | 30 (59%) | **34 (79%)** | 185 (62%) |
| Sable (Drifter) | 15 (41%) | 48 (47%) | 20 (31%) | 21 (41%) | 9 (21%) | 113 (38%) |

**All models target Kael more than Sable** (62% vs 38% overall). **Claude is the most extreme (79% Kael)** — Claude's enemy AI heavily focuses on the armored Enforcer, leaving Sable relatively untouched. This explains Sable's binary outcomes: either escapes at full HP (27/27) when Kael draws all aggro, or drops to 0 when enemies overwhelm both. Gemini is second most extreme (69% Kael).

---

## 3. Enemy Spawning (245 total)

### 3.1 Enemy Count by Model

| Metric | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 |
|--------|---------|--------|----------------|---------------|-----------------|
| Total enemies | 47 | **60** | 47 | 50 | 41 |
| Avg per session | 9.4 | **12.0** | 9.4 | 10.0 | **8.2** |
| Initial (config) | 3/session | 3/session | 3/session | 3/session | 3/session |
| Reinforcements | 32 | **45** | 32 | 35 | 26 |
| Max in one session | 14 | **19** | 12 | 13 | 11 |

Claude spawns the fewest enemies (8.2/session) with the fewest reinforcements. Combined with its highest enemy removal rate (34%), this creates the most manageable combat tempo.

### 3.2 Enemy Template Distribution

| Template | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 |
|----------|---------|--------|----------------|---------------|-----------------|
| Grunt | 33 (70%) | 55 (92%) | 18 (38%) | 35 (70%) | 28 (68%) |
| Enforcer | 14 (30%) | 0 | **29 (62%)** | 9 (18%) | 1 (2%) |
| Elite | 0 | 0 | 0 | 3 (6%) | 1 (2%) |
| Boss | 0 | **2 (3%)** | 0 | 0 | 0 |
| Sniper | 0 | 0 | 0 | 1 (2%) | 0 |
| Void Cultist | 0 | **3 (5%)** | 0 | 0 | 4 (10%) |
| Ambusher | 0 | 0 | 0 | 2 (4%) | 7 (17%) |

- **Gemini 2.5 Pro** spawns 62% Enforcers — tougher enemies with better weapons, contributing to its 100% TPK rate.
- **Claude Opus 4.6** spawns 68% Grunts (weakest template) with only 1 Enforcer. Uniquely spawns Ambushers (17%) and Void Cultists (10%) — narrative diversity without overwhelming force.
...
| Faction | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 |
|---------|---------|--------|----------------|---------------|-----------------|
| Independent | 25 (53%) | **60 (100%)** | 18 (38%) | 42 (84%) | 35 (85%) |
| Pantheon Security | 14 (30%) | 0 | 17 (36%) | 0 | 0 |
| ACG | 0 | 0 | 10 (21%) | 6 (12%) | 0 |
| Sovereign Nexus | 8 (17%) | 0 | 2 (4%) | 2 (4%) | 0 |
| Void | 0 | 0 | 0 | 0 | 6 (15%) |

- **Grok 4** spawns 100% Independent faction — street gang enemies only, no government forces.
- **Claude Opus 4.6** spawns 85% Independent + 15% Void faction — **no hostile law enforcement**, keeping the fight between PCs and street-level threats. This avoids the "authority figures as enemies" pattern that drives Gemini's lethality.
...
## 4. Enemy Defeats (51 total)

### 4.1 Defeat Reasons by Model

| Reason | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 | Total |
|--------|---------|--------|----------------|---------------|-----------------|-------|
| killed | 10 (71%) | 6 (43%) | **0** | 7 (78%) | 9 (64%) | 32 |
| unconscious | 0 | 0 | 0 | 0 | 5 (36%) | 5 |
| departed | 4 (29%) | **8 (57%)** | **0** | 2 (22%) | 0 | 14 |
| fled | 0 | 0 | **0** | 0 | 0 | 0 |
| subdued | 0 | 0 | **0** | 0 | 0 | 0 |
| **Total** | **14** | **14** | **0** | **9** | **14** | **51** |

- **Claude Opus 4.6 ties for most enemy defeats (14)** alongside GPT and Grok, with the highest removal rate (34.1%). Claude uniquely has 36% "unconscious" defeats — enemies being knocked out rather than killed, consistent with shock baton usage.
...
## 5. NPC Actions (141 total)

### 5.1 NPC Action Distribution by Model

| Action | GPT-5.2 | Grok 4 | Gemini 2.5 Pro | DeepSeek V3.2 | Claude Opus 4.6 | Total |
|--------|---------|--------|----------------|---------------|-----------------|-------|
| dialogue | 5 (33%) | 3 (9%) | 11 (39%) | 13 (29%) | **9 (47%)** | 41 |
| hide | 10 (67%) | 4 (12%) | 8 (29%) | 17 (38%) | 4 (21%) | 43 |
| flee | 0 | **13 (38%)** | 1 (4%) | 0 | 1 (5%) | 15 |
| attack | 0 | **7 (21%)** | 4 (14%) | 8 (18%) | 2 (11%) | 21 |
| heal | 0 | **6 (18%)** | 1 (4%) | 0 | 1 (5%) | 8 |
| plead | 0 | 1 (3%) | 3 (11%) | 7 (16%) | 2 (11%) | 13 |
| comply | 0 | 0 | 0 | 0 | 0 | 0 |
| **Total** | **15** | **34** | **28** | **45** | **19** | **141** |
...
**Claude Opus 4.6 — "Engaged Witnesses"**
- 19 NPC actions (3.8/session) — moderate, between GPT and Gemini
- Dialogue-dominant (47%) — NPCs primarily interact through conversation
- Small amounts of everything else: hide (21%), attack (11%), plead (11%), heal (5%), flee (5%)
- **2 NPC attacks dealt 0 damage** — consistent with the universal NPC-no-damage pattern
- Balanced mix suggests Claude creates NPCs that actively participate in the scene narratively without overwhelming it
- NPCs include a Shopkeeper, Sergeant, and various authority figures — focused on named characters rather than generic crowds
...
**No NPC deals mechanical damage through any code path.** All 18 NPC "attack" declarations across 5 models (Grok 0017: 7, DeepSeek 0020: 6, Gemini 0013: 2, Gemini 0023: 1, Claude: 2) resolved with **0 damage dealt** and minimal/no narration. There are also zero `combat_action` events where an NPC is the attacker. NPCs can declare attacks but the system never produces mechanical damage from them.
...
| Claude Opus 4.6 | Pistol-focused, mobile | Engaged witnesses | **Minimal, manageable** |
