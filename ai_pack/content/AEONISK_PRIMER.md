...
But judging and *alerting* are separate faculties. The Codex judges the instant
an act occurs — and notifies no one unless the deed was discovered, or its harm
was felt by somebody other than the actor. A private transgression is written in
full and reported to nobody: no patrol arrives, no Confessor calls. The fall is
real and it waits. It surfaces at the next gate, where a checkpoint reads your
*standing* and never your deed — so the door closes, service is refused, and
still no one is sent. That is the ordinary condition of the private sinner, and
the Codex does not regard it as escape. The gates are patient.
